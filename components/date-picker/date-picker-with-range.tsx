...
export function DatePickerWithRange({
  ...
  const handlePresetSelect = (
    preset:
      | (typeof rollingDateRangePresets)[0]
      | (typeof absoluteDateRangePresets)[0],
  ) => {
              ...
              <div className="border-r pr-4">
                <div className="flex items-center gap-1 mb-2">
                  <Button
                    ...
                    size="icon"
                    className="h-8 w-8"
                    onClick={() => goToPreviousMonth(true)}
                  >
                    <ChevronLeft className="h-4 w-4" />
                  </Button>
                  <div className="flex gap-1 flex-1">
                    <Select
                      value={getMonth(leftMonth).toString()}
                  ...
                  <Button
                    ...
                    disabled={
                      getMonth(leftMonth) === getMonth(new Date()) &&
                      getYear(leftMonth) === getYear(new Date())
                    }
                  >
              ...
              <div>
                <div className="flex items-center gap-1 mb-2">
                  <Button
                    ...
                    size="icon"
                    className="h-8 w-8"
                    onClick={() => goToPreviousMonth(false)}
                  >
                    <ChevronLeft className="h-4 w-4" />
                  </Button>
                  <div className="flex gap-1 flex-1">
                    <Select
                      value={getMonth(rightMonth).toString()}
                  ...
                  <Button
                    ...
                    disabled={
                      getMonth(rightMonth) === getMonth(new Date()) &&
                      getYear(rightMonth) === getYear(new Date())
                    }
                  >
                    <ChevronRight className="h-4 w-4" />
                  </Button>
